...
wordcloud(words_ho, freqs_ho, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
...
wordcloud(words_EAP, freqs_EAP, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
...
wordcloud(words_HPL, freqs_HPL, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
...
wordcloud(words_MWS, freqs_MWS, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
```
...
wordcloud(words_poe, freqs_poe, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
```
...
wordcloud(words_oed, freqs_oed, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
...
wordcloud(words_E, freqs_E, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
...
wordcloud(words_H, freqs_H, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
...
wordcloud(words_M, freqs_M, scale = c(14,.5), max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
