...
wordcloud(words_EAP, freqs_EAP, max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
...
wordcloud(words_HPL, freqs_HPL, max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
...
wordcloud(words_MWS, freqs_MWS, max.words = 50, color = c("blue4", "yellow2", "grey2"))
dev.off()
```
